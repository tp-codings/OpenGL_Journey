...
Life3D_Engine::Life3D_Engine()
{
	...
	this->cube = new Model("D:\\1. Programmieren\\OpenGL\\resources\\models\\cube\\cube.obj");
...
{
	this->screenShader = Shader("screen.vs", "screen.fs");
	this->particleShader = Shader("particles.vs", "particles.fs");
	this->cubeShader = Shader("cube.vs", "cube.fs");
	this->textShader = Shader("text.vs", "text.fs");
}
